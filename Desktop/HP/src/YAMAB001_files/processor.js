...
if (! self._FC2ANA2125943_0)
{
       var _FC2ANA2125943_0 =
       {
               uid:2125943,
               onclick:function (ev)
               {
                       ...
                       while (el)
                       {
                               if (el.tagName == "A")
                               {
                                       ...
                                       if (!is_mobile) {
                                               ...
                                               var img = new Image();
                                               img.src = "http://analyzer55.fc2.com/clicktrack.php?uid=" + this.uid
                                                       + "&ref=" + f(document.URL)
                                                       + "&url=" + f(el.href)
                                               ...
                                               var f = (self.encodeURIComponent || escape);
                                               var url = "http://analyzer55.fc2.com/clicktrack.php?js=1&uid=" + this.uid
                                                               + "&ref=" + f(document.URL)
                                                               + "&url=" + f(el.href)
                                                               + "&txt=" + f(el.innerHTML.replace(/<[^>]+>/g, ''))
                                                               + "&visitor=" + this.visit;
               ...
               disp_img:function()
               {
                       ...
                       document.write('<script type="text/javascript" language="javascript"'
                               + ' src="http://analyzer55.fc2.com/ana/analyzer.php?uid=' + this.uid
                               + '&amp;pid=0'
                               + '&amp;idsess='+ idSess
                               + '&amp;ref=' + escape(ref)
       ...
       _FC2ANA2125943_0.document_onclick = document.onclick;
       document.onclick = function(ev){
               return _FC2ANA2125943_0.onclick(ev);
       }
}
_FC2ANA2125943_0.disp_img();
